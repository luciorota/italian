...
define('XOOPS_LIB_PATH_HELP', 'Percorso fisico alla directory della libreria XOOPS SENZA barra finale, per compatibilit&agrave; futura. Colloca la cartella al di fuori di ' . XOOPS_ROOT_PATH . ' per renderla sicura.');
define('XOOPS_DATA_PATH_LABEL', 'Directory dei file di dati di XOOPS');
define('XOOPS_DATA_PATH_HELP', 'Percorso fisico alla directory dei file di dati (scrivibile) di XOOPS SENZA barra finale, per compatibilit&agrave; futura. Colloca la cartella al di fuori di ' . XOOPS_ROOT_PATH . ' per renderla sicura.');

define('DB_COLLATION_LABEL', 'Set di caratteri e collation del database');
define('DB_COLLATION_HELP', "A partire da MySQL 4.12 supporta set di caratteri e collation personalizzati. Tuttavia &egrave; pi&ugrave; complesso del previsto, quindi NON apportare alcuna modifica a meno che tu non sia sicuro della tua scelta.");
